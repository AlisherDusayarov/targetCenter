        ...
        try {
            ...
            if (parameter.equals("10")) {
                query = "select\n" +
                        ...
                        "  , t.CHANEL_WAY\n" +
                        "  , t.auto_number\n" +
                        //"  , LEFT(xmlserialize(xmlagg(xmlconcat(xmltext(t.digits6_name), xmltext(', '))) AS VARCHAR(2500)), LENGTH(xmlserialize(xmlagg(xmlconcat(xmltext(t.digits6_name), xmltext(', '))) AS VARCHAR(2500))) - 1) AS tovarlar\n" +
                ...
                query = "select\n" +
                        ...
                        "where (ea.STATE >= 160 and ea.state < 180) and st.lnga_tpcd = 'UZ' and mnz17.BALL is not null and DATE(ea.INSTIME) = CURRENT_DATE) AS t\n" +
                        "group by t.ball17\n" +
                        "  ,t.auto_number\n" +
                        "  ,t.CHANEL_WAY\n" +
                        "  ,t.end_country\n" +
                ...
                query = "select\n" +
                        ...
                        "where (ea.STATE >= 160 and ea.state < 180) and st.lnga_tpcd = 'UZ' and mnz8.BALL is not null and DATE(ea.INSTIME) = CURRENT_DATE) AS t\n" +
                        "group by t.ball8\n" +
                        "  ,t.auto_number\n" +
                        "  ,t.CHANEL_WAY\n" +
                        "  ,t.end_country\n" +
                ...
                query = "select\n" +
                        ...
                        "where (ea.STATE >= 160 and ea.state < 180) and st.lnga_tpcd = 'UZ' and mnz9.BALL is not null and DATE(ea.INSTIME) = CURRENT_DATE) AS t\n" +
                        "group by t.ball9\n" +
                        "  ,t.auto_number\n" +
                        "  ,t.CHANEL_WAY\n" +
                        "  ,t.end_country\n" +
                ...
                query = "select\n" +
                        ...
                        "where (ea.STATE >= 160 and ea.state < 180) and st.lnga_tpcd = 'UZ' and mnz14.BALL is not null and DATE(ea.INSTIME) = CURRENT_DATE) AS t\n" +
                        "group by t.ball14\n" +
                        "  ,t.auto_number\n" +
                        "  ,t.CHANEL_WAY\n" +
                        "  ,t.end_country\n" +
                ...
                query = "select\n" +
                        ...
                        "where (ea.STATE >= 160 and ea.state < 180) and st.lnga_tpcd = 'UZ' and mnz27.BALL is not null and DATE(ea.INSTIME) = CURRENT_DATE) AS t\n" +
                        "group by t.ball27\n" +
                        "  ,t.auto_number\n" +
                        "  ,t.CHANEL_WAY\n" +
                        "  ,t.end_country\n" +
