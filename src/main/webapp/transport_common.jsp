            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="widgets-icons ms-auto">
                        <img src="assets/images/tru.svg" alt="Truck" style="width: 42px" />
                    </div>
                </div>
        ...
        <div class="card radius-10">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="widgets-icons ms-auto">
                        <img src="assets/images/doc1.svg" alt="" style="width: 40px" />
                    </div>
                </div>
        ...
        <div class="card radius-10">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="widgets-icons ms-auto">
                        <img src="assets/images/coin.svg" alt="" style="width: 40px" />
                    </div>
                </div>
